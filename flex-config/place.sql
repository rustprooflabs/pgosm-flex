COMMENT ON TABLE osm.place_point IS 'Generated by osm2pgsql Flex output using pgosm-flex/flex-config/place.lua';
COMMENT ON TABLE osm.place_line IS 'Generated by osm2pgsql Flex output using pgosm-flex/flex-config/place.lua';
COMMENT ON TABLE osm.place_polygon IS 'Generated by osm2pgsql Flex output using pgosm-flex/flex-config/place.lua';
