...
COMMENT ON TABLE osm.water_polygon IS 'OpenStreetMap water water / waterway related polygons.  Includes combination of "natural" and "waterway" keys.  Generated by osm2pgsql Flex output using pgosm-flex/flex-config/water.lua';
